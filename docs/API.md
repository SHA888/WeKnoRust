...
WeKnowRust 提供了一系列 RESTful API，用于创建和管理知识库、检索知识，以及进行基于知识的问答。本文档详细描述了这些 API 的使用方式。
...
--data '{
    "name": "weknowrust",
    "description": "weknowrust tenants",
    "business": "wechat",
    "retriever_engines": {
        "engines": [
            {
...
--data '{
    "name": "weknowrust new",
    "description": "weknowrust tenants new",
    "status": "active",
    "retriever_engines": {
        "engines": [
            {
...
<div align="right"><a href="#weknowrust-api-文档">返回顶部 ↑</a></div>
...
--data '{
    "name": "weknowrust",
    "description": "weknowrust description",
    "chunking_config": {
        "chunk_size": 1000,
        "chunk_overlap": 200,
        "separators": [
...
--data '{
    "name": "weknowrust new",
    "description": "weknowrust description new",
    "config": {
        "chunking_config": {
            "chunk_size": 1000,
            "chunk_overlap": 200,
...
--header 'Content-Type: application/json' \
--data '{
    "url":"https://github.com/Tencent/WeKnowRust",
...
```json
{
    "data": {
        ...
        "title": "",
        "description": "",
        "source": "https://github.com/Tencent/WeKnowRust",
        "parse_status": "processing",
        "enable_status": "disabled",
        "embedding_model_id": "dff7bc94-7885-4dd1-bfd5-bd96e4df2fc3",
        "file_name": "",
