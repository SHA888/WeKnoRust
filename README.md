...
[**WeKnowRust**]() is the [Rust](https://www.rust-lang.org/) veriosn of [**WeKnowra**](https://weknowrust.weixin.qq.com), an LLM-powered framework designed for deep document understanding and semantic retrieval, especially for handling complex, heterogeneous documents. 
