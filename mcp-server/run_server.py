...
def check_environment():
    ...
    if not base_url:
        print("警告: WEKNOWRUST_BASE_URL 环境变量未设置，使用默认值: http://localhost:8080/api/v1")
    
    if not api_key:
        print("警告: WEKNOWRUST_API_KEY 环境变量未设置")
...
def main():
    """主函数"""
    print("启动 WeKnowRust MCP Server...")
    check_environment()
